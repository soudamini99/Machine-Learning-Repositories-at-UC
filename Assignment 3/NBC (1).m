classdef NBC<handle
    ...
    methods
        ...
        function PrepareProbabilities(obj, Data)
            ...
            %obj.species
            %(by using the values you got above)
            obj.Probability_Not_species = RowsNotSpecies/NumNotSpecies;
            %----------------------------------------------------------
        ...
        function Results = Identify(obj, Data)
            ...
            for i=1:size(Data, 1)
                ...
                Attribute_Values = [Data(i,1),Data(i,2),Data(i,3),Data(i,4)];
                NB_Species_positive = obj.Probability_species * (obj.MultipliedLikelyHoods(Attribute_Values,true));
                %----------------------------------------------------------
                ...
                NB_Species_Negative = obj.Probability_Not_species * (obj.MultipliedLikelyHoods(Attribute_Values,false));
                %----------------------------------------------------------
