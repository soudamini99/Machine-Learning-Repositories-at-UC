...
for j=5:5:20
    ...
    for i=1:RunningTime
        ...
        NumberOfSuccessNBC = length(BayesSuccessIndices(BayesSuccessIndices~=0));%INSERT THE NEEDED CODE HERE 
        ...
        AccuraciesNBC_EachBin(i) = AccuracyNBC;%INSERT THE NEEDED CODE HERE 
    end
    ...
    AccuraciesNBC(j/5,MIN_ACCURACY) = min(AccuraciesNBC_EachBin);%INSERT THE NEEDED CODE HERE 
    AccuraciesNBC(j/5,MAX_ACCURACY) = max(AccuraciesNBC_EachBin);%INSERT THE NEEDED CODE HERE 
    AccuraciesNBC(j/5,AVG_ACCURACY) = mean(AccuraciesNBC_EachBin);%INSERT THE NEEDED CODE HERE 
end
